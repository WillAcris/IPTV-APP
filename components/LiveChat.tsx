...
export const LiveChat: React.FC<LiveChatProps> = ({ channelName }) => {
  ...
  return (
    <div className="mt-6 bg-gray-50 dark:bg-slate-800/50 rounded-lg shadow-inner flex flex-col max-h-[calc(100vh-450px)] md:max-h-96">
      ...
      <form onSubmit={handleSendMessage} className="p-4 border-t border-gray-200 dark:border-slate-700 flex">
        <input
          ...
          className="flex-1 bg-white dark:bg-slate-700 border border-gray-300 dark:border-slate-600 rounded-l-md p-2 text-gray-900 dark:text-white focus:outline-none focus:ring-2 focus:ring-blue-500"
          aria-label="Chat message input"
        />
        <button
          type="submit"
          className="bg-blue-600 text-white font-bold py-2 px-4 rounded-r-md hover:bg-blue-700 transition-colors duration-200"
