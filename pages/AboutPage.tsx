  ...
  return (
    <div className="p-4 md:p-8 max-w-4xl mx-auto">
      <div className="bg-slate-800 p-6 md:p-8 rounded-lg shadow-2xl">
        <h1 className="text-3xl md:text-4xl font-bold mb-4 text-blue-300">About This IPTV Player</h1>
        ...
        <h2 className="text-2xl font-semibold mb-3 text-blue-300">A Message from the Developer</h2>
        ...
        <div className="mt-8 pt-6 border-t border-slate-700 text-center text-gray-500">
